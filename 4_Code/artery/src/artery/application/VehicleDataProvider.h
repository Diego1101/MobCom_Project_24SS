...
class VehicleDataProvider
{
	public:
		...
		/**Added by HS Esslingen, Noah Koehler,
		 * get & set methods for transmission range
		 **/
		uint16_t getTxRange() const {return mTxRange; } //Range that CAM Messages are transmitted
		void setTxRange(uint16_t newTxRange);
